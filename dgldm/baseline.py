...
class Baseline(pl.LightningModule):
    def __init__(self, aux_C_config, aux_G_config,  unet_config, style_config, content_config,
                 ...
                 show_debug=False, eps=1e-6, is_fixed_aux=False,
                 ):
        super().__init__()
        ...
        self.eps = eps
        self.is_fixed_aux = is_fixed_aux
        ...
        self.perceptual_loss = ContentPerceptualLoss().eval()
